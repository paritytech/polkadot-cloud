...
All extension data is stored in an `Extensions` object. The source code can be found <a href="https://github.com/paritytech/polkadot-cloud/blob/main/packages/assets/lib/extensions/index.tsx" target="_blank" rel="noreferrer">here</a>.
